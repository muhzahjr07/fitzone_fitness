...
<header class="site-header">
  <div class="container header-inner">
    <h1 class="logo">
      <a href="/index.php" class="logo-link">FitZone Fitness</a>
    </h1>
      ...
      <div style="display:flex;flex-direction: column;align-items: center;">
        <nav class="nav">
          ...
          <?php if (!empty($_SESSION['user'])): ?>
            ...
            <a href="/dashboards/<?=htmlspecialchars($_SESSION['user']['role'])?>.php">Dashboard</a>
        ...
        <form action="/pages/search.php" method="get" class="search-form" style="align-items: baseline;position: absolute;top: 130px;right: 15px;">
